...
from . import supabase_views, subscription_views
...
urlpatterns = [
    ...
    path('auth/admin/users', supabase_views.auth_admin_users, name='auth_admin_users'),
    path('auth/admin/users/<str:user_id>', supabase_views.auth_admin_user_by_id, name='auth_admin_user_by_id'),
    path('auth/admin/generate_link', supabase_views.auth_admin_generate_link, name='auth_admin_generate_link'),
    path('auth/admin/invite', supabase_views.auth_admin_invite, name='auth_admin_invite'),
    
    # Database endpoints (original format)
    path('db/select', supabase_views.db_select, name='db_select'),
    path('db/insert', supabase_views.db_insert, name='db_insert'),
    path('db/update', supabase_views.db_update, name='db_update'),
    path('db/delete', supabase_views.db_delete, name='db_delete'),
    ...
    path('storage/v1/object/<str:bucket_name>/<path:file_path>', supabase_views.storage_file_operations, name='storage_file_ops'),
    path('storage/v1/object/list/<str:bucket_name>', supabase_views.storage_list_files, name='storage_list'),
    path('storage/v1/object/public/<str:bucket_name>/<path:file_path>', supabase_views.storage_get_public_url, name='storage_public'),
    ...
    path('subscriptions/<str:subscription_id>/cancel',subscription_views.cancel_subscription,name="subscription_cancel"),
