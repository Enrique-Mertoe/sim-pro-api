# Generated by Django 5.2.5 on 2025-10-02 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['transfer_reference'], name='shop_transf_transfe_29f5d5_idx'), models.Index(fields=['status'], name='shop_transf_status_c588e0_idx'), models.Index(fields=['source_shop', 'destination_shop'], name='shop_transf_source__e7e183_idx'), models.Index(fields=['request_date'], name='shop_transf_request_3f789e_idx')],
            },
        ),
        migrations.CreateModel(
            name='ShopTarget',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['shop', 'period_start', 'period_end'], name='shop_target_shop_id_69be7c_idx'), models.Index(fields=['target_type'], name='shop_target_target__93d067_idx'), models.Index(fields=['is_achieved'], name='shop_target_is_achi_cbb102_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'shop_sales',
                'indexes': [models.Index(fields=['sale_reference'], name='shop_sales_sale_re_ec54bf_idx'), models.Index(fields=['shop', 'sale_date'], name='shop_sales_shop_id_7b675c_idx'), models.Index(fields=['customer_phone'], name='shop_sales_custome_37a4bf_idx'), models.Index(fields=['status'], name='shop_sales_status_9a056b_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['shop', 'period_type'], name='shop_perfor_shop_id_029b11_idx'), models.Index(fields=['period_start', 'period_end'], name='shop_perfor_period__40540e_idx'), models.Index(fields=['total_revenue'], name='shop_perfor_total_r_c939cb_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['shop', 'status'], name='shop_invent_shop_id_fdb6e7_idx'), models.Index(fields=['sold_date'], name='shop_invent_sold_da_f5abf6_idx'), models.Index(fields=['allocated_date'], name='shop_invent_allocat_497d9d_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['shop', 'created_at'], name='shop_audit__shop_id_cd0220_idx'), models.Index(fields=['action_type'], name='shop_audit__action__40b922_idx'), models.Index(fields=['user', 'created_at'], name='shop_audit__user_id_0b61bf_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='shop',
